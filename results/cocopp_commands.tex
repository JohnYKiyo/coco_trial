...
\providecommand{\cocoversion}{\hspace{\textwidth}\scriptsize\sffamily{}\color{Gray}Data produced with COCO v2.3.3.5}
\providecommand{\numofalgs}{2}
...
\providecommand{\algsfolder}{gpy_l_scp_f/}
\providecommand{\algorithmA}{gpy lcb}
\providecommand{\algorithmB}{scp fmin}
\providecommand{\bbobecdfcaptionsinglefunctionssingledim}[1]{
Empirical cumulative distribution of simulated (bootstrapped)
             runtimes, measured in number of objective function evaluations,
             divided by dimension (FEvals/DIM) for the $51$ 
...
\providecommand{\cocoversion}{\hspace{\textwidth}\scriptsize\sffamily{}\color{Gray}Data produced with COCO v2.3.3.5}
\providecommand{\numofalgs}{1}
\providecommand{\algname}{scp fmin{}}
\providecommand{\algfolder}{scp_fmin/}
